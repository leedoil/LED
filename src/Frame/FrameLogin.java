...
public class FrameLogin extends JFrame {
	...
	public FrameLogin() {
		...
		btnLogin.setBounds(360, 700, 87, 80);
		frame.add(btnLogin);
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (idBox.getText().equals("123") && pwBox.getText().equals("123")) {
				...
				/*
				else if(!idBox.getText().equals("123") && !pwBox.getText().equals("123")) {
					JOptionPane.showMessageDialog(null, "다시 입력해주세요!");
				}else if(!idBox.getText().equals("123") ) {
					JOptionPane.showMessageDialog(null, "비밀번호를 입력해주세요");
				}else if(pwBox.getText()!="123") {
